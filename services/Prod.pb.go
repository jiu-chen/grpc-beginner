...
func (ProdArea) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_Prod_proto_enumTypes[0].Descriptor()
}

func (ProdArea) Type() protoreflect.EnumType {
	return &file_proto_Prod_proto_enumTypes[0]
}
...
type QuerySize struct {
	...
	Size int32 `protobuf:"varint,1,opt,name=size,proto3" json:"size,omitempty"` //1是字段值编码
}

func (x *QuerySize) Reset() {
	*x = QuerySize{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_Prod_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*QuerySize) Descriptor() ([]byte, []int) {
	return file_proto_Prod_proto_rawDescGZIP(), []int{2}
}
...
func (x *ProdResponseList) Reset() {
	*x = ProdResponseList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_Prod_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProdResponseList) Descriptor() ([]byte, []int) {
	return file_proto_Prod_proto_rawDescGZIP(), []int{3}
}
...
var file_proto_Prod_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x08, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x12, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2f, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x22, 0x57, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x41, 0x72, 0x65, 0x61, 0x52,
	...
	0x1f, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x64, 0x41, 0x72, 0x65, 0x61, 0x12, 0x05, 0x0a, 0x01, 0x41,
	0x10, 0x00, 0x12, 0x05, 0x0a, 0x01, 0x42, 0x10, 0x01, 0x12, 0x05, 0x0a, 0x01, 0x43, 0x10, 0x02,
	0x32, 0xcf, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x3f, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x53, 0x74, 0x6f, 0x63, 0x6b,
	...
	0x00, 0x12, 0x42, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x53, 0x74, 0x6f, 0x63,
...
var file_proto_Prod_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_proto_Prod_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
func file_proto_Prod_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_Prod_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_Prod_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_proto_Prod_proto_enumTypes,
